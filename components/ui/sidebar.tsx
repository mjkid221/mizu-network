  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'duration-200 absolute inset-y-0 z-10 h-full w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex',
            side === 'left'
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // 'peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] min-h-svh md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2',
        className,
      )}
      {...props}
    />
